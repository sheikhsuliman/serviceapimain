...
( 1, 1, NOW(), '100.100.100.100.100', 5, 1, true, 'Primer coat on concrete base or cement coating. Consume approx. kg/m2 0.3.', 'On horizontal and slightly inclined surfaces', 3, 3.62 )
     ...
     , ( 1, 1, NOW(), '100.100.100.100.200', 6, 2, true, 'Primer coat on wooden base or ice coating. Consume approx. kg/m2 0.13.', null, 3, 4.12 )
     , ( 1, 1, NOW(), '100.100.100.100.200', 6, 3, true, 'Primer coat on wooden base or brick coating. Consume approx. kg/m2 0.666.', null, 3, 3.62 )
;
-- Trades
