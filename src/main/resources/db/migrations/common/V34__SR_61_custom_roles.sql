DROP TABLE IF EXISTS custom_role_permission;
DROP TABLE IF EXISTS custom_role;
DROP TABLE IF EXISTS custom_permission;
DROP FUNCTION IF EXISTS customRoleHasPermissions;

ALTER TABLE role
    ADD COLUMN description     VARCHAR(1024),
    ADD COLUMN deprecated      BOOLEAN DEFAULT false,
    ADD COLUMN member_default  BOOLEAN DEFAULT false,
    ADD COLUMN owner_default   BOOLEAN DEFAULT false,
    ADD COLUMN project_role    BOOLEAN DEFAULT false,
    ADD COLUMN system_role     BOOLEAN DEFAULT false
;

ALTER TABLE permission
    ADD COLUMN description          VARCHAR(1024),
    ADD COLUMN deprecated           BOOLEAN DEFAULT false,
    ADD COLUMN project_permission    BOOLEAN DEFAULT false,
    ADD COLUMN admin_permission     BOOLEAN DEFAULT false
;

-- Populate roles

DELETE FROM role;
INSERT INTO role (id, name, description, member_default, owner_default, project_role, system_role ) VALUES
(1, 'PROJECT_OWNER', 'Company Owner of Company which created the project', false, false, true, true),
(2, 'PROJECT_ADMIN', 'Delegate of Project Owner', false, false, true, false),
(3, 'PROJECT_MANAGER', 'Company Owner of Contractor Company invited to the project', false, false, true, true),
(4, 'PROJECT_WORKER', 'Worker of Contractor Company invited to the project', false, false, true, true),
(100, 'COMPANY_BOOTSTRAP', 'System Role, used to invite first company to the system', false, false, false, true),
(101, 'COMPANY_OWNER', 'Company Owner', false, true, false, true),
(102, 'COMPANY_ADMIN', 'Delegate of Company Owner', false, false, false, false),
(103, 'COMPANY_WORKER', 'Company Member', true, false, false, true);

-- Populate permissions

DELETE FROM permission;
INSERT INTO permission (id, name, description, deprecated, admin_permission, project_permission) VALUES
(1, 'PROJECT_READ_LIST', 'View List of Projects', true, false, false),
(2, 'PROJECT_READ_DETAILS', 'View Project details', false, false, true),
(3, 'PROJECT_UPDATE', 'Update Project', false, false, true),
(4, 'PROJECT_ARCHIVE', 'Archive Project', false, true, true),
...
(125, 'COMPANY_ARCHIVE', 'Archive Company', false, true, false),
(140, 'COMPANY_PROJECT_CREATE', 'Create Project', false, true, false),
...
(144, 'GLOBAL_CATALOG_EDIT', 'Edit Global Catalog', false, true, false),
(145, 'COMPANY_CATALOG_EDIT', 'Edit Company Catalog', false, true, false),
...
(149, 'COMPANY_ROLES_ASSIGN', 'Assign Company Roles', false, true, false),
(159, 'PROJECT_ROLES_ASSIGN', 'Assign Project Roles', false, true, true)
;

-- declare
CREATE OR REPLACE FUNCTION roleHasPermissions( IN roleName text, IN permissionNames text[]) RETURNS VOID
AS $function$
DECLARE
    i INT = 0 ;
    roleId int;
